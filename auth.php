    ...
    <body>
        <div class="mobile">
            ...
            <div class="row mt-4 d-block mx-auto">
                ...
                <div class="col-md-12 col-12 mt-3">
                    <button class="btn btn-primary text-left" style="background-color: #e0ac00 !important; border: 1px solid #e0ac00 !important;" onclick="location.href='login/moonton'"> <i class="zmdi zmdi-star" style="font-size: 2.9em;"></i> <div class="txtLogin2">Login with Moonton</div></button>
                </div>
            </div>
